...
public class Main {
	...
	public static void main(String[] args) {
		...
		//find POWER
			...
			System.out.println(("For every second, you used ")+(power)+(" joules."));
			
			System.out.println(" ");
			System.out.println("This is close to the amount of power required to");
			...
			if (power>0&&power<82) {
				...
				if (power>83&&power<150) {
					System.out.println(" sit at rest.");
					
			}
				
				if (power>151&&power<220) {
					System.out.println(" sit and study.");
